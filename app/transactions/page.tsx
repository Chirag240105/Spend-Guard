...
export default function Transactions() {
  ...
  useEffect(() => {
    fetch('/api/transactions?limit=100')
      .then(async (r) =>
        r.ok ? setData(await r.json()) : setError('Unable to load transactions.'),
      )
                ...
                filtered.map((i) => (
                  ...
                  >
                    ...
                    <td style={{ fontSize: 12, color: 'var(--muted)', whiteSpace: 'nowrap' }}>
                      {new Date(i.decision.createdAt).toLocaleDateString('en-US', {
                        month: 'short',
                        day: 'numeric',
                        hour: '2-digit',
                        minute: '2-digit',
                ...
                <tr>
                  ...
                  >
                    {search
                      ...
                      : 'No transactions yet. Evaluate a transaction to begin.'}
                  </td>
                </tr>
              )}
            </tbody>
